...
export const BotTyping = () => {
  ...
  const { botAvatar, botMsgColor, botMsgBackgroundColor,botAvatarLogo } = theme;
  return (
    botTyping && (
      <div className="flex space-x-1">
        ...
        <div
          className={`flex w-fit  space-x-2 self-start whitespace-pre-line break-words rounded-tl-[20px]  rounded-br-[25px] rounded-tr-[20px] rounded-bl-[5px] px-5 py-3 text-sm `}
